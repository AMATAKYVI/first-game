...
public class DoorHingeDetechZone : MonoBehaviour
{
    ...
    public DoorHingeController doorHinge;        // Assign this to DoorPrefab (has DoorHinge)
    ...
    void Update()
    {
        ...
        // Handle auto close only if the door is not locked
    ...
    System.Collections.IEnumerator HideLockedMessage()
    {
        ...
        if (lockedUI != null)
            lockedUI.SetActive(false); // Hide the locked UI
    }
